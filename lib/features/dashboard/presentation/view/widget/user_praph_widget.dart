...
class UserGraphWidget extends StatefulWidget {
  ...
  @override
  State<UserGraphWidget> createState() => _UserGraphWidgetState();
}

class _UserGraphWidgetState extends State<UserGraphWidget> {
  Color lineColor = const Color(0xFF09DD77);
